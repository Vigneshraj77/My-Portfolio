        ...
        return(
            <section className="skills">
                <div className="entry">
                    ...
                    <p>
                    Logical and results-driven Developer dedicated to building and optimizing user-focused websites for
          users with various business objectives. Judicious and creative when crafting effective software apps and
